...
// {
//     public class ScriptableObjectNodesViewModule<TNode> : INodesViewModule where TNode : INode<GraphRuntime<TNode>>
//     {
...
//
//         public ScriptableObjectNodesViewModule(
...
//         {
//             var (added, removed) = _nodes.Elements.Select(elem => elem.id).Diff(_graphRuntime.NodeMap.Keys);
//
